...
<nav class="sidebar sidebar-offcanvas m-0 fixed-left d-flex" id="sidebar">
    <ul class="nav">
        <li class="nav-item nav-profile">
            <a href="#home" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                    ...
                    <span class="text-secondary text-small" style="font-weight: bold; font-size: 1.2rem;"><?php echo " ".$_SESSION['name'];?></span>
                </div>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic" href="./mess_leave.php">
                <span class="menu-title">Mess Leave Request <i class="mdi mdi-view-list menu-icon" style="margin-left: 15px;"></i>
            ...
            <div class="collapse bg-light" style="border-radius: 50px;" id="ui-basic">
                <ul class="nav menu-title flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="./view_leave.php">View Leave Applications<i class="mdi mdi-menu-down mdi-24px text-primary"></i></a></li>
        ...
        <li class="nav-item">
        <a class="nav-link" href="./stud_news.php">
