...
<?php
include("../dbconnect.php");
$query = "SELECT COUNT(*) AS reg FROM studapp";
$result = mysqli_query($connect, $query);
if ($result) {
  $row = mysqli_fetch_assoc($result);
  $totaladd = $row['reg'];
...
<?php
include("../dbconnect.php");
$query = "SELECT COUNT(*) AS reg FROM studrej";
$result = mysqli_query($connect, $query);
if ($result) {
  $row = mysqli_fetch_assoc($result);
  $totalrej = $row['reg'];
                ...
                <a href="./accept_stud.php">
                  <div class="card-body">
                    ...
                    <h2 class="font-weight-normal mb-1" style="color: black;">
                      ...
                      <!-- studends count -->
                      <?php echo "Accepted Application: " . $totaladd; ?>
                    </h2>
                  </div>
                </a>
              </div>
                ...
                <a href="./stud_req.php">
                  <div class="card-body">
                    ...
                    <h2 class="font-weight-normal mb-1" style="color: black;">
                      ...
                      <!-- studends reg -->
                      <?php echo "View Applications: " . $totalreq; ?>
                    </h2>
                  </div>
                </a>
              </div>
                ...
                <a href="./rej_stud.php">
                  <div class="card-body">
                    ...
                    <h2 class="font-weight-normal mb-1" style="color: black;">
                      ...
                      <!-- studends feed -->
                      <?php echo "Rejected Students: " . $totalrej; ?>
                    </h2>
                  </div>
                </a>
