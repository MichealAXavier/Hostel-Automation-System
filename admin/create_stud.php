                ...
                <div class="content-wrapper p-4">
                    ...
                    <div class="grid-margin card p-3 stretch-card" style="overflow: hidden;">
                                ...
                                <table class="table table-responsive-xl">
                                    <thead class="bg-light asd">
                                        <tr>
                                            ...
                                            <th class="fw-bolder" scope="col">CLG_ADMISSION NO</th>
                        ...
                        if (isset($_POST['apID'])) {
                            ...
                            $qry = mysqli_query($connect, "SELECT * FROM studapp WHERE ap_id LIKE '%$searchID%'");
                        } else {
                            $qry = mysqli_query($connect, "SELECT * FROM studapp");
                        }
                        $i = 1;
                            ...
                            ?>
                                        <tr class="alert asd" role="alert">
                                            ...
                                            <td>
                                                <a href="create_profile.php?reg=<?php echo $row['reg']; ?>">
