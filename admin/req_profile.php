...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if (isset($_POST['approve'])) {
            ...
            $insert_sql = "INSERT INTO studapp (ap_id, stud_id, name, reg, dept, year, fathname, fathphone, age, dob, bldgrp, email, phone, address, image, request_letter, reg_date, physically_challenged, programme) VALUES (
            ...
            $mail->Body = 'Congratulations, ' . $row['name'] . '! Your Hostel Admission request has been approved.<br>Please contact Hostel Office.';
