...
if (isset($_POST['btn'])) {
    $qry = mysqli_query($connect, "select * from students where name='$sname' && reg='$psw'");
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-10">
                        <div class="wrap d-md-flex">
                            <div class="img" style="background-image: url(./admin/include/Manonmaniam-Sundaranar-University.jpg);">
                            </div>
